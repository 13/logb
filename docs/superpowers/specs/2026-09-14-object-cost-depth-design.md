...
1. **Include contents** switch. Shown when the object has at least one non-deleted child, archived
   or not -- archived children are not listed under Contents but still count. With the switch on,
   archived children still count toward the total, exactly as they do on the Statistics screen.
