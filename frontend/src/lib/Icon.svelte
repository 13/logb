<script lang="ts">
  ...
  export type IconName = 'back' | 'settings' | 'search' | 'document' | 'camera' | 'edit' | 'repeat'
    ...
    | 'palette' | 'person' | 'key' | 'box' | 'people' | 'database' | 'chevron' | 'logout' | 'bell';
...
>
  ...
  {:else if name === 'e-bike'}
    ...
    <path d="M12 17.5V15l-3-2 4-2 2 2h2" />
    <path d="M16.5 1.5 13 6h3l-3.5 4.5" />
  {:else if name === 'bike'}
    <circle cx="5.5" cy="17.5" r="3.5" />
    <circle cx="18.5" cy="17.5" r="3.5" />
  ...
  {:else if name === 'motorcycle'}
    ...
    <path d="M4.5 14.5h4l2.5-2h5l3 4.5" />
    <path d="M17 12.5V9.5h2" />
  {:else if name === 'home'}
